                ...
                <div class="card rounded shadow">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="store()">
                            <div class="mb-3">
                                <label for="" class="form-labe">Title</label>
                            ...
                            <div class="mb-3">
                                <label for="" class="form-labe">Amount</label>
                            ...
                            <div class="mb-3">
                                <label for="" class="form-labe">Time</label>
                                <input type="text" class="form-control" placeholder="yyyy-dd-mm hh:mm:ss" v-model="transaction.time">
                                <div v-if="validation.time" class="text-danger">
                                    {{ validation.time[0] }}
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-labe">Type</label>
